...
Usage: python bootstrap.py [--no-update] [--venv-dir venv]
"""
import argparse
import subprocess
import sys
...
def main():
    ...
    parser.add_argument('--venv-dir', default='venv', help='Path to create/use virtual environment')
    ...
    # Update blacklists and rebuild cache (if not skipped)
